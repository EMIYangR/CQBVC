...
let newLightHtml = '<span class="btn-inner--icon" id="light-span"><i class="bi bi-brightness-high" title="夜晚模式"></i></span>'


// $("#light").click({
//     $("#light-span").html(newLightHtml)
// })

// $("#light").click({
//     $(".docs").css("backgroud-color:#")
// })
// $("#light-span").replaceWith(newLightHtml)